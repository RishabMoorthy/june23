...
// config.properties in the sibling backend folder (relative to this file)
const CONFIG_PATH = path.join(__dirname, "../stubServerAuth-backend/build/stubserver_config/server/config.properties");
